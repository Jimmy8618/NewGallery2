...
public class MtpImageView extends ImageView {
    ...
    private static final String TAG = "MtpImageView";
    ...
    protected void onMtpImageDataFetchedFromDevice(Object result) {
        ...
        if (bitmapWithMetadata.bitmap == null) {
            Log.d(TAG, "onMtpImageDataFetchedFromDevice bitmapWithMetadata.bitmap is null!");
            return;
        }
