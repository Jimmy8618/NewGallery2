...
public class TiledTexture implements Texture {
    ...
    private static class Tile extends UploadedTexture {
        ...
        protected Bitmap onGetBitmap() {
            ...
            if (sCanvas == null) {
                ...
                return Bitmap.createBitmap(TILE_SIZE, TILE_SIZE, isLowRam ? Config.ARGB_4444 : Config.ARGB_8888);
            }
            /* @} */
            ...
            if (localBitmapRef != null) {
                ...
                if (!localBitmapRef.isRecycled() && sCanvas != null) {
                ...
                if (r < CONTENT_SIZE && sCanvas != null) {
                    sCanvas.drawLine(r, 0, r, TILE_SIZE, sPaint);
                }
                if (b < CONTENT_SIZE && sCanvas != null) {
    ...
    public static void freeResources() {
        ...
        if (sReferenceCount > 0) {
            Log.d(TAG, "do not freeResources, sReferenceCount is " + sReferenceCount);
            return;
        }
        sUploadBitmap = null;
        sCanvas = null;
