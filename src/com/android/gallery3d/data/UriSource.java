...
class UriSource extends MediaSource {
    ...
    private static final String APPLICATION_TYPE_PREFIX = "application/octet-stream";
    ...
    public Path findPathByUri(Uri uri, String type) {
        ...
        Log.d(TAG, "findPathByUri uri=" + uri + ", type=" + type + ", mimeType=" + mimeType);
        ...
        if (type.toLowerCase().contains(IMAGE_TYPE_PREFIX) || type.startsWith(APPLICATION_TYPE_PREFIX)) {
            try {
