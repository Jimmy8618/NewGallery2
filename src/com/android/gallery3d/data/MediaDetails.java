...
public class MediaDetails implements Iterable<Entry<Integer, Object>>, Serializable {
    ...
    public static final int INDEX_APERTURE = 105;  // f_number
    ...
    public static class FlashState implements Serializable {
        private static final long serialVersionUID = 1L;
    ...
    public static void extractExifInfo(MediaDetails details, Uri uri) {
        ...
        try {
            ...
            Log.w(TAG, "Could not find file to read exif: " + uri, e);
        } catch (IOException e) {
            Log.w(TAG, "Could not read exif from file: " + uri, e);
        } finally {
