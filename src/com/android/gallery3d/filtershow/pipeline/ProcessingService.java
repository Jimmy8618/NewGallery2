...
public class ProcessingService extends Service {
    ...
    private static final int mNotificationId = 10000;
    ...
    */
    ...
    public void handleSaveRequest(Uri sourceUri, Uri selectedUri,
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannel channel = new NotificationChannel(LOGTAG, getString(R.string.app_name),
                    NotificationManager.IMPORTANCE_LOW);
            mNotifyMgr.createNotificationChannel(channel);
            mBuilder.setChannelId(LOGTAG);
        }
