...
public class ProcessingTaskController implements Handler.Callback {
    ...
    private SparseArray<ProcessingTask> mTasks = new SparseArray<ProcessingTask>();

    public final static int RESULT = 1;
    public final static int UPDATE = 2;

    private static class MyHandler extends Handler {
        private final WeakReference<ProcessingTaskController> mProcessingTaskController;

        public MyHandler(ProcessingTaskController processingTaskController) {
            mProcessingTaskController = new WeakReference<>(processingTaskController);
        }

        @Override
        public void handleMessage(Message msg) {
            ProcessingTaskController processingTaskController = mProcessingTaskController.get();
            if (processingTaskController != null) {
                processingTaskController.handleMyHandlerMsg(msg);
            }
    ...
    private final Handler mResultHandler = new MyHandler(this);
