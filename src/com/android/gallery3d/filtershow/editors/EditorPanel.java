...
public class EditorPanel extends Fragment {
    ...
    private CropRatio mCropRatio = CropRatio.Ratio_Free;
    ...
    public void onAttach(Activity activity) {
        ...
        filterShowActivity.saveMenuItem(false);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mEditor != null) {
            Log.d(LOGTAG, "onCreateView mEditor = " + mEditor);
            if (mEditor instanceof EditorCrop) {
            ...
            mEditor.setCropRatio(mCropRatio);
        }
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.backToMain();
                int count = activity.getHistoryCount();
                if (count > 1) {
                    activity.saveMenuItem(true);
                }
            }
        });
