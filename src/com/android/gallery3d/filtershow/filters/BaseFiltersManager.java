...
public abstract class BaseFiltersManager implements FiltersManagerInterface {
    ...
    protected void addFilterClasses(Vector<Class> filters) {
        ...
        filters.add(ImageFilterDehaze.class);
    }
    ...
    public void addLooks(Context context) {
        int[] drawid = {
                ...
                R.drawable.filtershow_fx_0004_bw_contrast // for dehaze
        };
        ...
        int[] fxNameid = {
                ...
                R.string.ffx_dehaze // for dehaze
        };
    ...
    public void addTools(Context context) {
        ...
        FilterRepresentation[] geometryFilters = {
                new FilterCropRepresentation(FilterCropRepresentation.CropRatio.Ratio_Free),
                ...
                new FilterCropRepresentation(FilterCropRepresentation.CropRatio.Ratio_4_3),
                new FilterCropRepresentation(FilterCropRepresentation.CropRatio.Ratio_16_9),
                new FilterCropRepresentation(FilterCropRepresentation.CropRatio.Ratio_Square),
                new FilterCropRepresentation(FilterCropRepresentation.CropRatio.Ratio_Original),
        };
