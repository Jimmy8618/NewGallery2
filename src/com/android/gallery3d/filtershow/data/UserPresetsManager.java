...
public class UserPresetsManager implements Handler.Callback {
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<UserPresetsManager> mUserPresetsManager;

        public MyHandler(UserPresetsManager userPresetsManager) {
            mUserPresetsManager = new WeakReference<UserPresetsManager>(userPresetsManager);
        }

        @Override
        public void handleMessage(Message msg) {
            UserPresetsManager userPresetsManager = mUserPresetsManager.get();
            if (userPresetsManager != null) {
                userPresetsManager.handleMyHandlerMsg(msg);
            }
        }
    }
