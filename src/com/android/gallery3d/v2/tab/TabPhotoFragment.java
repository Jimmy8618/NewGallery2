...
public class TabPhotoFragment extends TabBaseFragment {
    ...
    public void loadData() {
        ...
        Fragment fragment = fm.findFragmentById(R.id.tab_photo_fragment_container);
        ...
        if (fragment == null) {
            ...
            bundle.putInt(Constants.KEY_BUNDLE_CONTAINER_ID, R.id.tab_photo_fragment_container);
            fragment.setArguments(bundle);
            //
            fm.beginTransaction()
                    .add(R.id.tab_photo_fragment_container, fragment)
                    .commit();
        }
    }
}
