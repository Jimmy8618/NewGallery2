...
public class TileImageViewAdapter implements TileImageView.TileSource {
    ...
    public Bitmap getTile(int level, int x, int y, int tileSize) {
        ...
        if (bitmap != null) {
            ...
            bitmap = Bitmap.createBitmap(tileSize, tileSize, isLowRam ? Config.ARGB_4444 : Config.ARGB_8888);
        }
        ...
        try {
            ...
            synchronized (regionDecoder) {
                Log.d(TAG, "getTile decodeRegion " + wantRegion + " start");
                bitmap = regionDecoder.decodeRegion(wantRegion, options);
                Log.d(TAG, "getTile decodeRegion " + wantRegion + " end");
            }
        } finally {
    ...
    private Bitmap getTileWithoutReusingBitmap(
        ...
        Bitmap result = Bitmap.createBitmap(tileSize, tileSize, isLowRam ? Config.ARGB_4444 : Config.ARGB_8888);
