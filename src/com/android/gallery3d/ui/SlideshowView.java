...
public class SlideshowView extends GLView {
    ...
    public void showBackgroundBitmap(Bitmap bitmap, int rotation) {
        if (mPrevTexture != null) {
            mPrevTexture.getBitmap().recycle();
            mPrevTexture.recycle();
        }
    ...
    protected void render(GLCanvas canvas) {
        ...
        synchronized (mMutex) {
            if (mPrevTexture != null && alpha != 1f && mPrevAnimation != null) {
            ...
            if (mCurrentTexture != null && mCurrentAnimation != null) {
