...
class PositionController {
    ...
    public static final int SNAPBACK_ANIMATION_TIME = 200;
    ...
    private static float SCALE_LIMIT = 4;
    ...
    public PositionController(Context context, Listener listener) {
        ...
        if (metrics.widthPixels > SCREENWIDTH && metrics.heightPixels > SCREENWIDTH) {
            SCALE_LIMIT = 5;
        }
        mListener = listener;
    ...
    public boolean inOpeningAnimation() {
        if (mPlatform == null) return false;
