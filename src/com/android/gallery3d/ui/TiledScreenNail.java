...
public class TiledScreenNail implements ScreenNail {
    ...
    protected TiledTexture mTexture;
...
//        GalleryUtils.start(this.getClass(), this + " hashcode :" + this.hashCode() +" - ondraw ");
...
//        GalleryUtils.end(this.getClass(), this + " hashcode :" + this.hashCode() +" - ondraw ");
    }
