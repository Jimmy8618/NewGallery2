...
public class FilterUtils {
    ...
    public static final int CLUSTER_BY_ALL = 2;
    public static final int CLUSTER_BY_PHOTO = 4;
    public static final int CLUSTER_BY_VIDEO = 32;
    ...
    public static void setupMenuItems(GalleryActionBar actionBar, Path path, boolean inAlbum) {
        ...
        setMenuItemApplied(actionBar, CLUSTER_BY_ALL,
                (ctype & CLUSTER_BY_ALL) != 0, (ccurrent & CLUSTER_BY_ALL) != 0);
        setMenuItemApplied(actionBar, CLUSTER_BY_PHOTO,
                (ctype & CLUSTER_BY_PHOTO) != 0, (ccurrent & CLUSTER_BY_PHOTO) != 0);
        setMenuItemApplied(actionBar, CLUSTER_BY_TAG,
                (ctype & CLUSTER_BY_TAG) != 0, (ccurrent & CLUSTER_BY_TAG) != 0);
        setMenuItemApplied(actionBar, CLUSTER_BY_VIDEO,
                (ctype & CLUSTER_BY_VIDEO) != 0, (ccurrent & CLUSTER_BY_VIDEO) != 0);
    ...
    public static boolean isLocalPhotoCluster(int clusterType) {
        return clusterType == CLUSTER_BY_PHOTO;
    }
}
