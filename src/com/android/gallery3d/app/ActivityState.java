...
abstract public class ActivityState {
    ...
    protected void transitionOnNextPause(Class<? extends ActivityState> outgoing,
        ...
        if (outgoing == SinglePhotoPage.class && incoming == SprdAlbumPage.class) {
            mNextTransition = StateTransitionAnimation.Transition.Outgoing;
        } else if (outgoing == SprdAlbumPage.class && incoming == SinglePhotoPage.class) {
    ...
    void resume() {
        ...
        if (null != layout) {
            if (this instanceof SprdAlbumSetPage && !mActivity.isGetContent() && !mActivity.isPick()) {
