...
public class MovieViewContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri
            .parse("content://com.sprd.gallery3d2/movieview");
    ...
    public static final Uri BOOKMARK_CONTENT_URI = Uri
            .parse("content://com.sprd.gallery3d2/bookmarks");
    ...
    static {
        ...
        URI_MATCHER.addURI("com.sprd.gallery3d2", "movieview",
                URI_MATCH_MOVIEVIEW);
        URI_MATCHER.addURI("com.sprd.gallery3d2", "movieview" + "/#",
                URL_MATCH_MOVIEVIEW_ID);
        URI_MATCHER.addURI("com.sprd.gallery3d2", "bookmarks",
                URI_MATCH_BOOKMARKS);
        URI_MATCHER.addURI("com.sprd.gallery3d2", "bookmarks" + "/#",
    ...
    public class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            try {
                ...
                statement.bindString(index++, String.valueOf(MovieViewProxySet.RTP_RTCP_MAX_PORT_VALUE));
                statement.bindString(index++, String.valueOf(MovieViewProxySet.RTP_RTCP_MIN_PORT_VALUE));
                //Bug 608339 @}
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        // UNISOC added for bug 1087538, avoid videoplayer crash.
            ...
            if (cmwap_id != null) {
                ...
                Toast.makeText(
                        ...
                        "current apn list has not  " + set_apn
                                + "apn ,set apn failured!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
