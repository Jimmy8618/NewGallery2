...
public class DrmUtil {
    ...
    public static String getFilePathByUri(Uri uri, Context context) {
        ...
        String filePath = "";
        //SPRD:Bug668119 Can't play a video in other devices connect by MTP
        if ((uri.getScheme().compareTo("content") == 0)
                && !"com.android.mtp.documents".equals(uri.getAuthority())) {
            ...
            try {
                ...
                e.printStackTrace();
                /* SPRD:Add for bug640727 com.android.gallery3d happens JavaCrash:java.lang.SecurityException @{ */
