...
static JNINativeMethod writeMethods[] = {{"setup",
                                         ...
                                         {
                                          "cleanup", "()V",                           (void *) OutputStream_cleanup},
                                         {"writeInputBytes",
...
static JNINativeMethod readMethods[] = {{"setup",
                                                ...
                                                (void *) InputStream_setup},
                                        {"cleanup",          "()V",
                                                (void *) InputStream_cleanup},
                                        {"readDecodedBytes", "([BII)I",
                                                (void *) InputStream_readDecodedBytes},
                                        {"skipDecodedBytes", "(I)I",
