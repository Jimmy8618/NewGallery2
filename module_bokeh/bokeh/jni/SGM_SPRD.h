...
void *sprd_depth_Init(struct depth_init_inputparam *inparam, struct depth_init_outputparam *outputinfo,
...
int
sprd_depth_distancemeasurement(int *distance, void *disparity, DistanceTwoPointInfo *points_info);
