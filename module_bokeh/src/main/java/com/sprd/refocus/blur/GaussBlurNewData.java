...
/**
 * blur1.0, 2.0 GaussianBlur
 */

public class GaussBlurNewData extends CommonBlurData {

    public GaussBlurNewData(byte[] content) {
        super(content, TYPE_BLUR_GAUSS);
    }
    ...
    public void initDatas(byte[] content) {
        ...
        jpegSize = content.length - oriJpegSize - 123 * 4;
